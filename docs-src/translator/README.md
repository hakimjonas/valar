Thank you, that's a critical detail to get right in the documentation. You are correct; the `ValidationObserver` is a foundational pattern that lives in `valar-core`, making it available to all users.
